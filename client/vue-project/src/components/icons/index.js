...
export { default as IconEquipment } from './IconEquipment.vue';
export { default as IconRepairs } from './IconRepairs.vue';
export { default as IconTemplates } from './IconTemplates.vue';
export { default as IconLessons } from './IconLessons.vue';
...
export { default as IconStudents } from './IconStudents.vue';
