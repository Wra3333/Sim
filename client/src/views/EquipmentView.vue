  ...
  <div class="equipment-view">
    <div class="toolbar">
      ...
      <div class="toolbar-right">
        ...
        <!-- Импорт Excel — admin, methodist, technician -->
        <button
        ...
        <!-- Экспорт Excel — admin, methodist, technician -->
        <button
          v-if="authStore.hasRole('admin', 'methodist', 'technician')"
          class="btn btn-outline-secondary"
        ...
        <!-- Показать архив — admin, technician -->
        <button
        ...
        <!-- Добавить — admin, methodist, technician -->
        <button
          v-if="authStore.hasRole('admin', 'methodist', 'technician')"
...
import {
  IconEquipment, IconPlus, IconImport, IconExport, IconReset, IconArchive, IconFilter
...
const equipmentViewMode = computed({
  ...
  set: (val) => { viewMode.value.equipment = val; }
});
